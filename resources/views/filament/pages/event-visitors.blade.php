    ...
    <div class="space-y-6">
                ...
                <div class="fi-section-content px-6 pb-6">
                    @if($this->getVisitors()->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by adding a visitor.</p>
                        </div>
                    @else
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Click on an event tab above to view its visitors.
                </p>
            </div>
        @endif
    </div>
